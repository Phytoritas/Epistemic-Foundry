...
FINDING_CODES: dict[str, str] = {
    ...
    "SELECTIVE_ACCOUNTING_MISBOUND": (
        "the statistical record's selective-inference verdict does not match the "
        "report it claims to summarize, so its recommendation was copied from a "
...
def derive_selective_admissibility(
    *,
    ...
    report = _require_mapping(selective_report, "selective_report")
