...
FINDING_CODES: dict[str, str] = {
    ...
    "BUDGET_DIMENSION_OVERRUN": (
        "a measured resource dimension exceeded a hard ceiling the declared "
...
def require_bounded_qualification_budget(
    *,
    ...
    a forecast can never be presented as a limit.  This gate records measured cost
    descriptively and holds each measured resource dimension only against its
    matching non-null hard limit, refusing an overrun by the name of the dimension
    it breached.  The receipt is content-addressed.
    """
