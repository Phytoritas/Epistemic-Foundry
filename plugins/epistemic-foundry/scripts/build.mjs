...
const FOUNDRY_KERNEL_FILES = Object.freeze([
  ...
  "effects/durable-mutation-orchestrator.mjs",
  ...
  "forge/classifier/classification-worker-authority.mjs",
  "forge/classifier/work-classification-worker.mjs",
  "forge/fsm/index.mjs",
  ...
  "forge/session/session-open-worker.mjs",
  "forge/session/session-transition-worker.mjs",
  "forge/session/session-worker-authority.mjs",
...
const PLUGIN_HOST_FILES = Object.freeze([
  ...
  "mcp/write/adapter.mjs",
  "mcp/write/catalog-set.mjs",
  "mcp/write/generated/t02-tool-descriptors.json",
  "cli/command-surface.mjs",
  "cli/envelope.mjs",
  "cli/error-codes.mjs",
  "cli/pathless.mjs",
