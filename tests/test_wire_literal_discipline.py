...
DECLARING_MODULES: frozenset[str] = frozenset(
    {
        ...
        "epistemic_species_archive/islands.py",
        ...
        "governance/quarantine.py",
        "shinka_adapter/backend.py",
        "shinka_adapter/isolation.py",
        "security/skills.py",
        ...
        "evaluation/novelty_layers.py",
        "evaluation/fitness.py",
        "evaluation/bandits.py",
        "evaluation/surrogate.py",
        "validation_bay/replication.py",
        "statistics/sequential.py",
        "statistics/selective.py",
        "statistics/search_record.py",
        "release/replay.py",
