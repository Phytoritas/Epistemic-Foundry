#!/usr/bin/env python3
"""Run L04-0001 verification into attempt-local evidence files only."""
...
CHECKS = {
    "syntax": syntax,
    "targeted": lambda: node_test(TARGETED, "targeted-l04-node"),
    "l01": lambda: node_test(L01, "predecessor-l01-node"),
    "l02": lambda: node_test(L02, "predecessor-l02-node"),
    "l03": lambda: node_test(L03, "predecessor-l03-node"),
    "full-node": full_node,
