#!/usr/bin/env python3
"""Build and verify T05-0001 evidence: Evolution CLI/MCP tools, sandbox executors and Shinka backend adapter.
...
ATTEMPT_ID = "T05-0001"
WORK_PACKAGE_ID = "T05"
RECORDED_AT = "2026-08-02T18:00:00.000Z"
ATTEMPT_DIR = "artifacts/work_packages/T05/attempts/0001"
AUTHORITY_DECISION = "HD-EF4-T05-SCOPE-20260802-001"

EXPECTED_PRODUCT_HASHES = {
    "artifacts/work_packages/T05/attempts/0001/check_packaging.py": "53c7b7fa3e7f0fda37c4c067844a298da1c54f1684fc749fbc0c3119b58772c6",
    "artifacts/work_packages/T05/attempts/0001/fixtures.py": "204d11d931747348f4fc4346f6fcf4cf29ff468820b09f28ece9f044e8537f38",
    "artifacts/work_packages/T05/attempts/0001/pytest.ini": "67f12ac2a4b667d8ad8626bd8e5937dc68c050fe5abb9bbe9d23b1c447e4bbf3",
    "artifacts/work_packages/T05/attempts/0001/run_t05_0001_checks.py": "b2fab7c7b1b1f8edbc6f38b86925dda52c5202ed87c30ce792516711839c743a",
    "artifacts/work_packages/T05/attempts/0001/test_negative_adversarial.py": "7e787cfae451179ff61393b00eb8d3124751189b61a44ab78a4e459c3227d7d9",
    "artifacts/work_packages/T05/attempts/0001/test_provenance_receipts.py": "36b7668efd767440d354097efc7418660b01eb41cac3e4a68ffd63d27981b984",
    "artifacts/work_packages/T05/attempts/0001/test_schema_and_type.py": "8ca5ee67836bb0f7430768f12812cf9aa8514ca70059d12bb8d4fec436986dc5",
    "artifacts/work_packages/T05/attempts/0001/test_unit_contract.py": "564514af44a1877b86ed6ca91c99661cc44c4e19e0d2965b28d0440c11763d1a",
    "src/epistemic_foundry/adapters/__init__.py": "ff605d61d0b4c5a9968a1bb3d9249102fcf2d7a56368716bc1c1d53424900214",
    "src/epistemic_foundry/adapters/v4_t05/__init__.py": "aeca7e07f9a0a46d6abd406d0fa1572daa3a51bf4a3ab0748541f92273fbe343",
    "src/epistemic_foundry/adapters/v4_t05/backend_adapter.py": "8003ea463f43d77506f3c7170cf8c603ebf0a7705831ab917764a82581f73090",
    "src/epistemic_foundry/adapters/v4_t05/findings.py": "a3963edcbb60577f7bbfcf76b593abd8da72363023531cb7006aa7ffd7c31df6",
    "src/epistemic_foundry/adapters/v4_t05/tool_surface.py": "504364a58f8c8a98bcc4be19c1204b60dd026fe41a42fa55c9dafc9dd979f255",
}
EXPECTED_DEPENDENCY_HASHES = {
    "artifacts/authority_decisions/HD-EF4-T05-SCOPE-20260802-001.human-decision.json": "32fe65a5c3cea9a4b7c401b216140c24d035023e88f54205edfadeff05a58053",
...
JUNIT_PATHS = {
    ...
    "dependency_regression_shinka": ATTEMPT / "dependency-regression-shinka.junit.xml",
    ...
    "targeted_t05_adapter": ATTEMPT / "targeted-t05-adapter.junit.xml",
...
OUTPUT_NAMES = (
    "build_t05_0001_evidence.py",
    "check_packaging.py",
    "commands.jsonl",
    "dependency-regression-s05.junit.xml",
    "dependency-regression-shinka.junit.xml",
    ...
    "pytest.ini",
    "review.md",
    "run_t05_0001_checks.py",
    "schema-and-type-check.junit.xml",
    "t05-verification.json",
    "t05_0001_rah_seal.py",
    "targeted-t05-adapter.junit.xml",
...
def regression_evidence() -> dict[str, Any]:
    ...
    for label, summary, expected in (
        (
            ...
            pytest_summary(JUNIT_PATHS["dependency_regression_s05"]),
            62,
        ),
        (
            "dependency_regression_shinka",
            pytest_summary(JUNIT_PATHS["dependency_regression_shinka"]),
            74,
        ),
        ...
        (
            "targeted_t05_adapter",
            pytest_summary(JUNIT_PATHS["targeted_t05_adapter"]),
            101,
        ),
        (
...
def dependency_status() -> dict[str, Any]:
    ...
    status: dict[str, Any] = {
        ...
        "next_action": "SEAL_T05_0001_THEN_CONTINUE_DAG",
...
def write_scope_verification() -> dict[str, Any]:
    ...
    return {
        "approved_scope": [
            "src/epistemic_foundry/adapters/v4_t05/**",
            "artifacts/work_packages/T05/**",
            "src/epistemic_foundry/adapters/__init__.py (HD-EF4-T05-SCOPE-20260802-001)",
        ],
        "attempt_id": ATTEMPT_ID,
...
def package_verification(regression: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "declaring_sources": {
            "backend_surfaces": (
                "shinka_adapter backend/isolation modules (composed, refusals unswallowed)"
            ),
            "execution_gate": (
                "security.v4_s05 qualify_candidate_execution (composed)"
            ),
            "tool_surface": (
                "plugin_blueprint v4_g05 evolution-surface.json (read per call)"
            ),
            "verdicts": ("backend-adapter-qualification schema enum (positional)"),
        },
        "exit_criteria": {
            "all_completion_and_external_effects_resolve_to_immutable_receipts": {
                "mechanism": (
                    "every record re-derives its hash, every identifier and timestamp is caller-supplied with no new_id and no clock, and byte-identical output across calls is asserted"
                ),
                "status": "PASS",
            },
            "governing_schemas_authority_boundaries_failure_states_exact": {
                "mechanism": (
                    "backend manifests and qualifications validate against their canonical schemas, the verdict vocabulary is read positionally, pipeline stages come from the reconciliation module, and the adapter's own 749-value scan proves zero held enum values"
                ),
                "status": "PASS",
            },
            "happy_negative_crash_resume_adversarial_coverage": {
                "mechanism": (
                    "an unpinned backend, an overclaimed capability, an unbound execution profile, unreconciled import counts and an executor for an unprojected command are each refused by their own codes, and G05's zero-of-25-projected finding is reproduced exactly rather than contradicted"
                ),
                "status": "PASS",
            },
            "no_candidate_model_prompt_backend_or_hook_acquires_authority": {
                "mechanism": (
                    "EF4-I63 is enforced as BACKEND_AUTHORITY_LEAK across the ten authority surfaces: imported scores, archives and novelty can never bind into promotion or evaluator fields, and an envelope claiming authority is refused"
                ),
                "status": "PASS",
            },
        },
    ...
    records.append(
        {
            ...
            "command": [
                "python",
                "-B",
                f"{ATTEMPT_DIR}/build_t05_0001_evidence.py",
                "build",
            ],
            "exit_code": 0,
            "recorded_at_utc": RECORDED_AT,
...
def report_document(
    ...
    *,
    ...
    report: dict[str, Any] = {
        "attempt_id": ATTEMPT_ID,
        "attempt_type": "T05_EVOLUTION_TOOLS_BACKEND_ADAPTER",
        ...
        "next_package": "D06-0001",
        "not_claimed": [
            "running ShinkaEvolve: no build was fetched or exercised; capability tests are recorded claims the gate cross-checks, not behavioural evidence",
            "schema changes: the canonical qualification admits no extra fields, so T05 wraps rather than proposes edits",
...
def build() -> dict[str, Any]:
    ...
    write_json("t05-verification.json", verification)
...
def bind_rah_state(
    *,
    ...
    if "rah_state" in stored:
        raise SystemExit("T05-0001 report is already RAH-bound")
    ...
    verification = read_json(ATTEMPT / "t05-verification.json")
    report = report_document(
...
def verify() -> dict[str, Any]:
    ...
    if render(expected) != render(stored):
        raise SystemExit("stored T05-0001 report is not the deterministic document")
    return _summary()
