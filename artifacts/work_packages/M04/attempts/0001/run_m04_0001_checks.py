#!/usr/bin/env python3
"""Run M04-0001 checks into attempt-local evidence files only."""
...
CHECKS = {
    "syntax": syntax,
    "targeted": lambda: node_test(M04_TESTS, "targeted-m04-node"),
    "combined": lambda: node_test(
        (*M01_TESTS, *M02_TESTS, *M03_TESTS, *M04_TESTS),
        "combined-m01-m02-m03-m04-node",
    ),
