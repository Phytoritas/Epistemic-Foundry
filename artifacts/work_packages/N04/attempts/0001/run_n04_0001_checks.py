#!/usr/bin/env python3
"""Run N04-0001 checks into attempt-local immutable evidence files."""
...
CHECKS = {
    "syntax": syntax,
    "targeted": lambda: node_test(N04_TESTS, "targeted-n04-node"),
    "n02-regression": lambda: node_test(N02_TESTS, "n02-adapter-regression"),
    "n03-regression": lambda: node_test(N03_TESTS, "n03-scheduler-regression"),
