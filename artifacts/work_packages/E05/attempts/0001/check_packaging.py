#!/usr/bin/env python3
"""Prove the E05 engine is discoverable by the project's own packaging config.

Without ``src/epistemic_foundry/effects/__init__.py`` the engine imports from a
...
(HD-EF4-E05-SCOPE-20260802-001).  This check reads the discovery mode from
...
EXPECTED = ("epistemic_foundry.effects", "epistemic_foundry.effects.v4_e05")
