#!/usr/bin/env python3
"""Run M03-0001 checks into attempt-local evidence files only."""
...
CHECKS = {
    "syntax": syntax,
    "targeted": lambda: node_test(M03_TESTS, "targeted-m03-node"),
    "combined": lambda: node_test(
        (*M01_TESTS, *M02_TESTS, *M03_TESTS), "combined-m01-m02-m03-node"
    ),
