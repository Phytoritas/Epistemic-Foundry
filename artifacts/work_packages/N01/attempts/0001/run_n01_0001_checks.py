#!/usr/bin/env python3
"""Run N01-0001 checks into attempt-local evidence files only."""
...
def pytest_file(test_path: str, name: str) -> int:
    return run(
        [
            "uv",
            "run",
...
CHECKS = {
    "syntax": syntax,
    "targeted": lambda: node_test(N01_TESTS, "targeted-n01-node"),
    "security": lambda: pytest_file("tests/test_security.py", "security-python"),
    "dispatch-contract": lambda: pytest_file("tests/test_contracts.py", "dispatch-contract-python"),
