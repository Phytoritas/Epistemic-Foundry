#!/usr/bin/env python3
"""Run N03-0001 checks into attempt-local evidence files only."""
...
CHECKS = {
    "syntax": syntax,
    "targeted": lambda: node_test(N03_TESTS, "targeted-n03-node"),
    "n01-regression": lambda: node_test(N01_TESTS, "n01-role-contract-regression"),
    "e02-regression": lambda: node_test(E02_TESTS, "e02-effect-regression"),
    "e03-regression": lambda: node_test(E03_TESTS, "e03-capability-regression"),
