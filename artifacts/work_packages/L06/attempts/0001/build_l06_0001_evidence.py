#!/usr/bin/env python3
"""Build and verify L06-0001 evidence: Memory retention, deletion and legal-hold integration gate.
...
ATTEMPT_ID = "L06-0001"
WORK_PACKAGE_ID = "L06"
RECORDED_AT = "2026-08-02T17:15:00.000Z"
ATTEMPT_DIR = "artifacts/work_packages/L06/attempts/0001"
AUTHORITY_DECISION = None

EXPECTED_PRODUCT_HASHES = {
    "artifacts/work_packages/L06/attempts/0001/check_packaging.py": "c29170bedb7202005d97f5ab5fa22f4c2c5265a2767e03f11f69bb1c60553ff3",
    "artifacts/work_packages/L06/attempts/0001/fixtures.py": "2d226d869a4c450ec552b1fae9d50a04a4ab5d0e21988f4c03dbdf987b8d4ce3",
    "artifacts/work_packages/L06/attempts/0001/pytest.ini": "f662f2da75f533abbdbb5665b2c58afde12e75d1da31fb8e4f0f158a45879568",
    "artifacts/work_packages/L06/attempts/0001/run_l06_0001_checks.py": "649b4726f620b2262b7dccb7568e5e2a21026fd9a81ec5129537b92f06161fab",
    "artifacts/work_packages/L06/attempts/0001/test_negative_adversarial.py": "61525ed144298a6eebd28834063a94e68edda85f1a0a800ccf965d4a213c4f13",
    "artifacts/work_packages/L06/attempts/0001/test_provenance_receipts.py": "0e682fc4b96521f1408c01c604dd55a8a59a02e811015bb1034a9a3c7a1e79dc",
    "artifacts/work_packages/L06/attempts/0001/test_schema_and_type.py": "7f2c09e4dc8b99fd4575962062b205a93aba94694eb604af55b6e0870cb07351",
    "artifacts/work_packages/L06/attempts/0001/test_unit_contract.py": "b627a1987bdb7e7f0e6a36e2c4379d01871d6ea81da4313d76d04bbc6e12bc2b",
    "src/epistemic_foundry/memory/v4_l06/__init__.py": "ec7b2fe9afa057d72b284cea64aed7743a2cc185a17ee200a3d4f48135dfeeb7",
    "src/epistemic_foundry/memory/v4_l06/gate.py": "613e1644a0d28f105931ff10710b32975be3ff2e2995394e2211c1fb867732ed",
}
...
JUNIT_PATHS = {
    "dependency_regression_memory": ATTEMPT / "dependency-regression-memory.junit.xml",
    "dependency_regression_retention": ATTEMPT
    ...
    "targeted_l06_gate": ATTEMPT / "targeted-l06-gate.junit.xml",
...
def regression_evidence() -> dict[str, Any]:
    ...
    for label, summary, expected in (
        (
            "dependency_regression_memory",
            pytest_summary(JUNIT_PATHS["dependency_regression_memory"]),
            61,
        ),
        (
            "dependency_regression_retention",
            pytest_summary(JUNIT_PATHS["dependency_regression_retention"]),
            72,
        ),
        ...
        ("targeted_l06_gate", pytest_summary(JUNIT_PATHS["targeted_l06_gate"]), 127),
        (
...
def dependency_status() -> dict[str, Any]:
    ...
    status: dict[str, Any] = {
        ...
        "dependencies": {
            ...
            "L05": _sealed_dependency("L05", "L05-0001", "E0171", "E0172"),
        },
        "next_action": "SEAL_L06_0001_THEN_CONTINUE_DAG",
...
def write_scope_verification() -> dict[str, Any]:
    ...
    return {
        "approved_scope": [
            "src/epistemic_foundry/memory/v4_l06/**",
            "artifacts/work_packages/L06/**",
        ],
        "attempt_id": ATTEMPT_ID,
...
def package_verification(regression: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        "attempt_id": ATTEMPT_ID,
        "declaring_sources": {
            "forget_grounds": ("memory/v4_l05 FORGET_GROUNDS (composed)"),
            "memory_classes": ("memory/policy.py MEMORY_CLASSES"),
            "protected_classes": ("epistemic_species_archive PROTECTED_ENTRY_CLASSES"),
        },
        "exit_criteria": {
            "all_completion_and_external_effects_resolve_to_immutable_receipts": {
                "mechanism": (
                    "hold placements, execution verdicts and sweep audits re-derive their own hashes; the dependency regressions pin their collected counts so a green exit cannot hide an empty collection"
                ),
                "status": "PASS",
            },
            "governing_schemas_authority_boundaries_failure_states_exact": {
                "mechanism": (
                    "grounds, memory classes and protected classes are imported from their owners, L05 refusals are wrapped as UPSTREAM_MEMORY_REFUSED with the upstream code and context preserved and raise-from chained, and the repository discipline gate passes 5/5"
                ),
                "status": "PASS",
            },
    ...
    records.append(
        {
            ...
            "command": [
                "python",
                "-B",
                f"{ATTEMPT_DIR}/build_l06_0001_evidence.py",
                "build",
            ],
            "exit_code": 0,
            "recorded_at_utc": RECORDED_AT,
...
def report_document(
    ...
    *,
    ...
    report: dict[str, Any] = {
        "attempt_id": ATTEMPT_ID,
        "attempt_type": "L06_RETENTION_DELETION_LEGAL_HOLD_GATE",
        ...
        "not_claimed": [
            "physical deletion: the gate verifies the report a runtime produces; the transaction and its effect receipt belong to the D05 store owner, and a runtime lying identically in report and store is outside detection",
            "execution of the D05 PostgreSQL suite in this attempt (resource isolation during the parallel wave); it ran green in the D06 attempt the same day",
...
def build() -> dict[str, Any]:
    ...
    write_json("l06-verification.json", verification)
...
def bind_rah_state(
    *,
    ...
    if "rah_state" in stored:
        raise SystemExit("L06-0001 report is already RAH-bound")
    ...
    verification = read_json(ATTEMPT / "l06-verification.json")
    report = report_document(
...
def verify() -> dict[str, Any]:
    ...
    if render(expected) != render(stored):
        raise SystemExit("stored L06-0001 report is not the deterministic document")
    return _summary()
