#!/usr/bin/env python3
"""Prove the Y06 qualification gate is discoverable by packaging.

``operations`` is an existing package marker and ``operations.v4_y06`` is the
qualification surface this work package adds under it, so there is a scope
...
EXPECTED = ("epistemic_foundry.operations", "epistemic_foundry.operations.v4_y06")
