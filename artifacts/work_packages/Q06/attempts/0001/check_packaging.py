#!/usr/bin/env python3
"""Prove the Q06 governance-integration gate is discoverable by packaging.

``src/epistemic_foundry/evaluation`` is an existing package marker (Q05 ships
under it) and ``evaluation.v4_q06`` is the new marker this package adds, so there
...
EXPECTED = ("epistemic_foundry.evaluation", "epistemic_foundry.evaluation.v4_q06")
