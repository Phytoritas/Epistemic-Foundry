#!/usr/bin/env python3
"""Run N02-0001 checks into attempt-local evidence files only."""
...
CHECKS = {
    "syntax": syntax,
    "targeted": lambda: node_test(N02_TESTS, "targeted-n02-node"),
    "n01-regression": lambda: node_test(N01_TESTS, "n01-role-contract-regression"),
    "host-capability-regression": lambda: node_test(
        HOST_CAPABILITY_TESTS, "host-capability-regression"
    ),
